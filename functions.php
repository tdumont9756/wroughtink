...
define( 'CHILD_THEME_NAME', 'Wrought Ink' );
//define( 'CHILD_THEME_SLUG', 'wroughtink');
...
function genesis_sample_enqueue_scripts_styles() {
	...
	/*
	* enqueu the styles and scripts for featherlight
	*/
	wp_enqueue_style(
		'featherlight-css',
		get_stylesheet_directory_uri() ."/featherlight/featherlight.css"
	);
...
// Adds theme support for custom header on home page.
if(is_front_page()){
	$wi_homepage_header_settings = array(
		"width"       => 400,
		"height"      => 400
	);
	add_theme_support("custom_header", $wi_homepage_header_settings);
}
